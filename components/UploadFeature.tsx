    ...
    <section className="py-12 bg-gray-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="lg:text-center">
          <h2 className="text-base text-blue-600 font-semibold tracking-wide uppercase">Upload</h2>
          ...
          <div className="mt-4 text-center">
            <TooltipProvider>
              <Tooltip>
                ...
                <TooltipContent>
                  <p>We support STL, OBJ, and STEP files. Make sure your model is watertight and properly scaled.</p>
                </TooltipContent>
              </Tooltip>
            </TooltipProvider>
          </div>
